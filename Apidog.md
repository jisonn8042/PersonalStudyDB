...
1. 上段の住所入力欄に登録するAPIのメソッド、既に入力されているbaseURLの後ろにendpointを作成
2．住所を書く欄の右にある保存をクリック
...
3. APIの仕様に合う値を選択及び入力
4. 右にあるパラメータ値を入力するところをクリックし
5. APIの仕様に合う値を選択及び入力
6. 住所を書く欄の右にある保存をクリック

</br>

#### 2.4. Body作成

APIの仕様を確認し、リクエストに必要なデータを作成します。

> Body作成方法

1. "Headers"メニューの左にある"Body"メニューをクリック
2. 下にある小さいメニュー(none, from-data等)API仕様に合わせて内容形式を選択
3. 仕様に合わせて内容を作成
4．住所を書く欄の右にある保存をクリック

</br>

#### 2.5. parameter作成

APIの仕様を確認し、リクエストに記入するパラメータ値を作成します。

> parameter作成方法

1. "Body"メニューの左にある"Params"メニューをクリック
2. パラメータ名の下にある"パラメータを追加"をクリック
3. APIの仕様に合わせて記入する値を入力
4. 右にあるパラメータ値を入力するところをクリック
5. APIの仕様に合わせて記入する値を入力
6. 住所を書く欄の右にある保存をクリック
